...
#ifdef VENDOR_EDIT
/* Yichun.Chen  PSW.BSP.CHG  2018-06-07  putting QMP PHY in power down state during disconnect */
                else {
                        writel_relaxed(0x00, phy->base + phy->phy_reg[USB3_PHY_POWER_DOWN_CONTROL]);
                }
#endif
