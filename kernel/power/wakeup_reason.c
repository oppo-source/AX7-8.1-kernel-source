...
#ifdef VENDOR_EDIT
#ifdef VENDOR_EDIT
//Jiemin.Zhu@AD.Performance.Power, 2016/05/12, add for modem wake up source
...
#ifdef VENDOR_EDIT
/* Wenxian.Zhen@PSW.BSP.Power.Basic, 2016/07/19, add for analysis power consumption */
...
#ifdef VENDOR_EDIT
//Jiemin.Zhu@AD.Performance.Power, 2016/05/24, Add for wake up source
