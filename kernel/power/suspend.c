...
#ifdef VENDOR_EDIT
/*Yunqing.Zeng@BSP.Kernel.Statbily, 2018/04/28, Add for speed up suspend workaround*/
/**
...
int pm_suspend(suspend_state_t state)
{
	...
	#ifdef VENDOR_EDIT
	//Chen.Yan@BSP.sensor,2018/06/11,move adsp suspend before sys_sync to avoid sensor event interrupt suspend
